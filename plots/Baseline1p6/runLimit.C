...
void runLimit(){
    ...
    // Bin mapping (from label inspection):
    // 1=All 2=passDQ 3=1track 4=MissingP 5=HCal 6=HCalCell10 7=HCalCell0.1 8=ECal
    for(int i=0;i<nP;i++){
